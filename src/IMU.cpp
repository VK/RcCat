...
bool IMU::loop()
{
  ...
  if (i2c.readByte(MPU9250_ADDRESS, INT_STATUS) & 0x01)
  { // check if data ready interrupt
    ...
    if (accelCount[0] == -1 && accelCount[1] == -1 && accelCount[2] == -1 && gyroCount[0] == -1 && gyroCount[1] == -1 && gyroCount[2] == -1)
    {
      runInit();
      return false;
    }
    ...
    fuseIMU(gy * PI / 180.0f, gx * PI / 180.0f, gz * PI / 180.0f, ay, ax, az, deltat, kp * (1.0 - tan((1.0 - a_tot) * (1.0 - a_tot) * tot_a_scaler)));
